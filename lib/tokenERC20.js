...
const rele = "x509::/C=US/ST=North Carolina/O=Hyperledger/OU=admin/CN=org1admin::/C=US/ST=North Carolina/L=Durham/O=org1.example.com/CN=ca.org1.example.com"
...
class TokenERC20Contract extends Contract {
    ...
    */
    ...
    async Mint(ctx, to, amount) {
        ...
        const balanceKey = ctx.stub.createCompositeKey(balancePrefix, [to]);
